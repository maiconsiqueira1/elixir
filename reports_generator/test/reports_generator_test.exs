defmodule ReportsGeneratorTest do
  ...
  describe "fetch_higher_cost/2" do
    test "when de option is  'users' returns the user who spent the most" do
      file_name = "report_test.csv"
    ...
    test "when de option is  'foods' returns the food who spent the most" do
      file_name = "report_test.csv"
    ...
    test "when the an invalid option is given, returns error" do
      file_name = "report_test.csv"
