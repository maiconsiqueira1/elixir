defmodule ReportsGenTest do
  ...
  describe "build_many/1" do
    test "build a report from a many files - parallelism" do
      filenames = ["part_1.csv", "part_2.csv", "part_3.csv"]

      response = ReportsGen.build_many(filenames)
  ...
  describe "build_many/2" do
    test "error when filenames is not a list" do
      filenames = "part_1.csv"

      response = ReportsGen.build_many(filenames)

      expected_response = {:error, "it is not a list"}
